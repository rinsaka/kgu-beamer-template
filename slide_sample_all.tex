...
\begin{frame}{はじめに}
  \begin{itemize}
    \item スライドのマージンを確認するための文章です．スライドのマージンを確認するための文章です．スライドのマージンを確認するための文章です．スライドのマージンを確認するための文章です．
    \item スライドのマージンを確認するための文章です．スライドのマージンを確認するための文章です．スライドのマージンを確認するための文章です．スライドのマージンを確認するための文章です．
  \end{itemize}
  スライドのマージンを確認するための文章です．スライドのマージンを確認するための文章です．スライドのマージンを確認するための文章です．スライドのマージンを確認するための文章です．

  This is for previewing the margins of the slides. This is for previewing the margins of the slides. This is for previewing the margins of the slides. This is for previewing the margins of the slides.
\end{frame}
...
\begin{frame}{2段組み}
  \begin{columns}
    \begin{column}{0.5\textwidth}
      \begin{itemize}
        \item 2段組みのレイアウトです．2段組みのレイアウトです．2段組みのレイアウトです．2段組みのレイアウトです．2段組みのレイアウトです．2段組みのレイアウトです．2段組みのレイアウトです．
      \end{itemize}
    \end{column}
    \begin{column}{0.5\textwidth}
      \begin{itemize}
        \item 2段組みのレイアウトです．2段組みのレイアウトです．2段組みのレイアウトです．2段組みのレイアウトです．2段組みのレイアウトです．2段組みのレイアウトです．2段組みのレイアウトです．2段組みのレイアウトです．2段組みのレイアウトです．2段組みのレイアウトです．2段組みのレイアウトです．
      \end{itemize}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}{表のアニメーション(1)}
  ...
  \begin{center}
    \begin{tabular}
      ...
      \multicolumn{1}{c}{左揃え} &
      \multicolumn{1}{c}{右揃え} \\ \Hline
      2021 & AAAAAAAA & 22222222 \\ \hline \pause
      2022 & AAAAAA & 222222 \\ \hline
      2023 & AAAA & 2222 \\ \hline \pause
      2024 & AA & 22 \\ \hline
      2025 & A & 2 \\ \Hline
    \end{tabular}
  \end{center}
...
\begin{frame}{表のアニメーション(2)}
  ...
  \begin{center}
    \begin{tabular}
      ...
      \multicolumn{1}{c}{左揃え} &
      \multicolumn{1}{c}{右揃え} \\ \Hline
      \onslide<4->2021 & AAAAAAAA & 22222222 \onslide<1-> \\ \hline
      \onslide<3->2022 & AAAAAA & 222222 \onslide<1-> \\ \hline
      \onslide<2->2023 & AAAA & 2222 \onslide<1-> \\ \hline
      2024 & AA & 22 \\ \hline
      2025 & A & 2 \\ \Hline
    \end{tabular}
  \end{center}
...
\begin{frame}{表のアニメーション(3)}
  ...
  \begin{center}
    \begin{tabular}
      ...
      \multicolumn{1}{c}{左揃え} &
      \multicolumn{1}{c}{右揃え} \\ \Hline
      2021 & \onslide<2->AAAAAAAA & \onslide<3->22222222 \onslide<1->\\ \hline
      2022 & \onslide<2->AAAAAA & \onslide<3->222222 \onslide<1->\\ \hline
      2023 & \onslide<2->AAAA & \onslide<3->2222 \onslide<1->\\ \hline
      2024 & \onslide<2->AA & \onslide<3->22 \onslide<1->\\ \hline
      2025 & \onslide<2->A & \onslide<3->2 \onslide<1->\\ \Hline
    \end{tabular}
  \end{center}
\end{frame}
